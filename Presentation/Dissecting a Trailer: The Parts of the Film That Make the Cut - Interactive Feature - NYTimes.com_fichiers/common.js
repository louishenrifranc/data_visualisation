...
/*
 * $Id: common.js 155249 2017-01-30 16:46:47Z gopi_borra $
...
(function (jQuery) {
    ...
    var loadProfileImage = function (memberId, memberName) {
        ...
        profileImage.src = tpHost.replace('http://', 'https://s3.amazonaws.com/') + '/' + memberId.substring(4,0) + '/' + memberId.substring(4) + '/cropped-' + memberId + '.jpg';
    };
