...
function scatterPlot(scatterGraph, countries) {
    ...
    */
	...
	scatterGraph.append("g")
		...
		.enter()
		.append("circle")
		.attr("cx", function(d){return x(d.values.LifeExpectancy)})
		.attr("cy", function(d){return y(d.values.Income)})
		.attr("r", function(d){return r(d.values.Population)})
		.attr("fill", function(d){return color(d.values.Region)})
		.attr("id", function(d){return normalizeName(d.name)})
